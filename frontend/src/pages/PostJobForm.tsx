...
import { Briefcase, Building, MapPin, Clock, Monitor, User, DollarSign, FileText, X } from 'lucide-react';
          ...
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm mt-1">Create a new job listing to attract top talent</p>
              </div>
            </div>
            <button 
              onClick={handleClose}
